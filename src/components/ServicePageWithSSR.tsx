...
/**
 * ServicePageWithSSR - Service page with SSR/SSG support
 * 
 * Unlike the generic ServicePage which renders a neutral shell during SSR,
 * this component receives fallback data and renders the full service page
 * on the server. This matches the BlogPost pattern.
 * 
 * Key differences from ServicePage:
 * - Receives service as a prop (from fallback data)
 * - Always renders full content (no neutral shell)
